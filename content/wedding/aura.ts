// Contenido real de la invitación "Aura" (Valentina & Patricio), portado
// del proyecto de Flor (React/Vite) a este formato. Dato ficticio de
// práctica confirmado por Facu el 26/08/2026 — no son datos reales de
// ninguna pareja, sirve como demo del diseño en la galería pública.
//
// Mismo patrón que el resto de content/*.ts: acá solo datos, la UI vive
// en components/wedding/aura/.
...
export const AURA_STORY: StoryMilestone[] = [
  {
    year: "2019",
    date: "14 de octubre",
...
export const AURA_SCHEDULE: ScheduleEvent[] = [
  {
    time: "16:30",
...
export const AURA_GALLERY: GalleryImage[] = [
  {
    id: "g1",
...
export const AURA_ACCOMMODATION: AccommodationItem[] = [
  {
    id: "stay-1",
...
export const AURA_BANK_ACCOUNTS: BankAccount[] = [
  {
    currency: "ARS",
